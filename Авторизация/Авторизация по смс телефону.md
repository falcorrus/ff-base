...
FirebaseAuth/PhoneAuthProvider.swift:77: Fatal error: Please register custom URL scheme app-1-713949114792-ios-******* in the app's Info.plist file.
...
Потом не забудьте загрузить apn ключь в cloud messaging)
